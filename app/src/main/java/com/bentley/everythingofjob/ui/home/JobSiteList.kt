...
object JobSiteList {
    ...
    private val list = listOf(
            ...
            JobSiteItem("워크넷", "#고용노동부 #실업급여", R.drawable.worknet, "https://www.work.go.kr/"),
...
//        JobSiteItem("점핏", "#IT #개발자", R.drawable.jumpit, "https://biz.jumpit.co.kr/"),
            ...
            JobSiteItem("건설워", "#건설", R.drawable.worker, "http://m.worker.co.kr/"),
